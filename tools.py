...
{{
    "issues": ["问题"],
    "adjustments": [
        {{"item": "物品", "current": "当前值", "suggested": "建议值"}}
    ]
}}"""
        ...
        return {"economy": content}


def create_tools(**kwargs) -> AIGameDevTools:
    """创建游戏开发工具"""
    return AIGameDevTools(**kwargs)


if __name__ == "__main__":
    tools = create_tools()

    print("AI Game Dev Tools")
    print()
